document.addEventListener('DOMContentLoaded', function() {
    ...
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getdata', true);
...
document.getElementById('btnInsFilter').addEventListener('click', function () {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getinscritsdata/filter?start_date=' + formattedStartDate + '&end_date=' + formattedEndDate, true);
...
document.getElementById('btnInsReload').addEventListener('click', function () {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getinscritsdata/filter', true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
document.getElementById('btnLscFilter').addEventListener('click', function () {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getlscdata/filter?start_date=' + formattedLscStartDate + '&end_date=' + formattedLscEndDate, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
document.getElementById('btnLscReload').addEventListener('click', function () {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getlscdata/filter', true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
function updateLanguageChart(selectedGroup,selectedLangue=null){
    ...
    contentLG.classList.add('d-none');
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getlanguagedata/'+ selectedLangue, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
function updateDigitalModule(selectedGroup,selectedDigital=null){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getdigitaldata/'+ selectedDigital, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
function updateLpData(selectedGroup, selectedLp=null){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getlpdata/'+ selectedLp, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
...
function updateSMModule(selectedGroup,selectedSM=null){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/project/groups/'+ selectedGroup +'/getsmdata/'+ selectedSM, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                var data = JSON.parse(xhr.responseText);
