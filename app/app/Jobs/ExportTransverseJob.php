...
class ExportTransverseJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Log::info("['start'][$start_datetime]: Export data transverse has started.");
        ...
        $csvExporter->beforeEach(function ($enroll) use ($userfields, $enrollfields) {
            ...
            if ($learner) {
                ...
                } elseif ($enroll->status == 'not_started') {
                ...
                $enroll->enrollment_completion_percentage = $enroll->enrollment_completion_percentage . '%';
        ...
        Log::info("['end'][$end_datetime]: Export data transverse has finished.");
    }
}
