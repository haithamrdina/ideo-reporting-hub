...
class ExportMoocJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Log::info("['start'][$start_datetime]: Export data mooc has started.");
        ...
        Log::info("['end'][$end_datetime]: Export data mooc has finished.");
    }
}
