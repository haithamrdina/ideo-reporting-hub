...
class ExportSpeexJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Log::info("['start'][$start_datetime]: Export data langues has started.");
        ...
        $csvExporter->beforeEach(function ($enroll) use ($userfields, $enrollfields) {
            ...
            $enroll->niveau = $enroll->niveau != null ? $enroll->niveau : "******";
            $enroll->language = $enroll->language != null ? $enroll->language : "******";
        ...
        Log::info("['end'][$end_datetime]: Export data langues has finished.");
    }
}
