...
class MoocExport implements FromArray, WithMapping, WithHeadings, WithStrictNullComparison, WithTitle, ShouldAutoSize, WithStyles
{
    ...
    public function array(): array
    {
        ...
        if ($this->datedebut != null && $this->datefin != null) {
            ...
            if ($archive == true) {
                ...
                $learnersIds = Learner::where('statut', '!=', 'archive')->where('group_id', $this->groupId)->pluck('docebo_id')->toArray();
                $moocEnrolls = Enrollmooc::whereIn('learner_docebo_id', $learnersIds)->where('group_id', $this->groupId)->get()->toArray();
            }
        }
        return $moocEnrolls;
    }
    ...
    public function map($row): array
    {
        ...
        $data = [
            ...
            Mooc::where('docebo_id', $row['mooc_docebo_id'])->first()->name,
