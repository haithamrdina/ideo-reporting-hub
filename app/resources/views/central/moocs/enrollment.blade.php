                    ...
                    <div class="col d-flex flex-column">
                        <div>
                            <div class="row align-items-center p-2 m-2">
                                <div class="col-auto">
                                    <h2>Liste des inscriptions aux moocs</h2>
                                </div>
                            </div>
                            <div>
                                <div id="table-enrollmoocs" class="table-responsive">
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap datatable">
                                            ...
                                            <tbody class="table-tbody">
                                                @php
                                                    use Carbon\Carbon;
                                                @endphp
                                                @if (count($enrollMoocs) > 0)
                                                    @foreach ($enrollMoocs as $enroll)
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var listjs = new List('table-enrollmoocs', options);
