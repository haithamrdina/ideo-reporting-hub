                    ...
                    <div class="col d-flex flex-column">
                        <div>
                            <div class="row align-items-center p-2 m-2">
                                <div class="col-auto">
                                    <h2>Liste des inscriptions aux  modules langues</h2>
                                </div>
                            </div>
                            <div>
                                <div id="table-enrolllangues" class="table-responsive">
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><button class="table-sort" data-sort="sort-niveau">Niveau</button></th>
                                                    <th><button class="table-sort" data-sort="sort-langue">Langue</button></th>
                                                    <th><button class="table-sort" data-sort="sort-session">Temps de session</button></th>
                                                    <th><button class="table-sort" data-sort="sort-cmi">Temps sur speex</button></th>
                                            ...
                                            <tbody class="table-tbody">
                                                @php
                                                    use Carbon\Carbon;
                                                @endphp
                                                @if (count($enrollLangues) > 0)
                                                    @foreach ($enrollLangues as $enroll)
                                                            ...
                                                            <td class="sort-niveau">
                                                                {{ $enroll->niveau != null ? $enroll->niveau : '******'}}
                                                            </td>
                                                            <td class="sort-langue">
                                                                {{ $enroll->language}}
                                                            </td>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var listjs = new List('table-enrolllangues', options);
