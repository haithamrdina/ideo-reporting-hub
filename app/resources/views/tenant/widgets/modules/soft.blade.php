...
<div class="card h-100">
    <div class="card-body">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-success pt-2 text-white">
                            Terminé
                            <div class="h5" id="insSoftT">{{ $softStats['statSoftskills']['completed'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-warning pt-2 text-white">
                            En cours
                            <div class="h5" id="insSoftP">{{ $softStats['statSoftskills']['in_progress'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-danger pt-2 text-white">
                            Non démarré
                            <div class="h5" id="insSoftND">{{ $softStats['statSoftskills']['enrolled'] }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row fw-bolder">
                    <div class="col-md-12 card  border-0 mb-1">
                        ...
                        <div class="card-body bg-danger-lt pt-2 text-black">
                            Temps de session
                            <div class="h5" id="sessionSoft">{{ $softStats['statSoftTimes']['total_session_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card  border-0 mb-1 {{ $cmi_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-bitbucket-lt pt-2 text-black">
                            Temps d'engagement
                            <div class="h5" id="cmiSoft">{{ $softStats['statSoftTimes']['total_cmi_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card  border-0 mb-1 {{ $calculated_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-yellow-lt pt-2 text-black">
                            Temps calculé
                            <div class="h5" id="tcSoft">{{ $softStats['statSoftTimes']['total_calculated_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card  border-0 mb-1 {{ $recommended_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-green-lt pt-2 text-black">
                            ...
                            <div class="h5" id="trSoft">{{ $softStats['statSoftTimes']['total_recommended_time'] }}</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div id="chart-softs">
                    {{  $softStats['softCharts']  !=null  ?  $softStats['softCharts']->render() : ''}}
                </div>
            </div>
        </div>
    </div>
