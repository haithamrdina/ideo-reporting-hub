            ...
            <div class="row g-2">
                <div class="col">
                    <div class="form-group">
                        <select type="text" class="form-select" id="select-enis" placeholder="Séléctionner votre module" value="">
                            <option value="">Séléctionner votre module</option>
                            @foreach($digitalStats['modulesDigital'] as $module)
                ...
                <div class="row">
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-success pt-2 text-white">
                            Terminé
                            <div class="h5" id="insEniT">{{ $digitalStats['statDigital']['enrolled'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-warning pt-2 text-white">
                            En cours
                            <div class="h5" id="insEniP">{{ $digitalStats['statDigital']['in_progress'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-4 card  border-0">
                        <div class="card-body bg-danger pt-2 text-white">
                            Non démarré
                            <div class="h5" id="insEniND">{{ $digitalStats['statDigital']['completed'] }}</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div id="chart-digital">
                    {{  $digitalStats['digitalCharts']  !=null  ?  $digitalStats['digitalCharts']->render() : ''}}
                </div>
            </div>
                ...
                <div class="row fw-bolder">
                    <div class="col-md-12 card border-0 mb-1">
                        ...
                        <div class="card-body bg-danger-lt pt-2 text-black">
                            Temps de session
                            <div class="h5" id="sessionEni">{{ $digitalStats['statDigitalTimes']['total_session_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card border-0 mb-1  {{ $cmi_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-bitbucket-lt pt-2 text-black">
                            Temps d'engagement
                            <div class="h5" id="cmiEni">{{ $digitalStats['statDigitalTimes']['total_cmi_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card border-0 mb-1  {{ $calculated_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-yellow-lt pt-2 text-black">
                            Temps calculé
                            <div class="h5" id="tcEni">{{ $digitalStats['statDigitalTimes']['total_calculated_time'] }}</div>
                        </div>
                    </div>
                    <div class="col-md-12 card border-0 mb-1  {{ $recommended_time_conf != true ? 'opacity-10' : '' }}">
                        ...
                        <div class="card-body bg-green-lt pt-2 text-black">
                            ...
                            <div class="h5" id="trEni">{{ $digitalStats['statDigitalTimes']['total_recommended_time'] }}</div>
                        </div>
                    </div>
                </div>
            </div>
