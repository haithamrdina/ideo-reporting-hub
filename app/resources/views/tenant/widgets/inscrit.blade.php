    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions btn-actions d-md-block d-sm-block d-lg-block d-none">
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        <a href="javascript:void(0)" class="btn btn-icon" aria-label="Button" id="btnInsFilter"
                    ...
                    <div class="col-auto">
                        <a href="javascript:void(0)" class="btn btn-icon" aria-label="Button" id="btnInsReload"
                    ...
                    @if (request()->routeIs('tenant.plateforme.home') ||
                        ...
                        <div class="col-auto">
                            <a href="javascript:void(0)" class="btn  text-black" aria-label="Button" id="btnInsExport"
        ...
        <div class="card-body p-2">
            ...
            <div class="row row-cards" id="contentInscrits">
                <div
                    class="{{ $archive == true && request()->routeIs('tenant.plateforme.home') ? 'col-md-3' : 'col-md-4' }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h5 mb-0 me-2 text-black fw-bolder ">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-math-avg" width="24" height="24"
                                        viewbox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
