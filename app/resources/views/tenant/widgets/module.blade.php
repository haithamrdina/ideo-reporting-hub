        ...
        <div
            ...
            {{-- @if (request()->routeIs('tenant.plateforme.home') || request()->routeIs('tenant.project.home') || request()->routeIs('tenant.group.home'))
                <div class="card-actions btn-actions d-md-block d-sm-block d-lg-block">
                    <div class="row g-2">
                        <div class="col-auto">
                            <a href="javascript:void(0)" class="btn  text-black" aria-label="Button" id="btnModulesExport"
        ...
        <div class="card-body p-2">
            <div class="row row-cards">
                                    ...
                                    <div class="row g-2">
                                        <div class="col">
                                            <div class="form-group">
                                                <select type="text" class="form-select" id="select-sms"
                                                    value=""></select>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <a href="javascript:void(0)" class="btn btn-icon" aria-label="Button"
                                                id="btnSMReload" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="card-body">
                                <div class="container container-slim py-4 d-none" id="loaderSM">
                                    <div class="text-center">
                                        ...
                                        <div class="text-muted mb-3">Vos données sont en cours de préparation, merci de
                                            patienter un instant.</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 text-center">
                                    <div class="row fw-bolder">
                                        ...
                                        <div
                                            class="col-md-12 card  border-0 mb-1 {{ $cmi_time_conf != true ? 'opacity-10' : '' }}">
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                data-bs-target="#modal-engaged-time">
                                                <div class="ribbon ribbon-top bg-bitbucket">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div
                                            class="col-md-12 card  border-0 mb-1 {{ $calculated_time_conf != true ? 'opacity-10' : '' }}">
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                data-bs-target="#modal-calculated-time">
                                                <div class="ribbon ribbon-top bg-yellow">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div
                                            class="col-md-12 card  border-0 mb-1 {{ $recommended_time_conf != true ? 'opacity-10' : '' }}">
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                data-bs-target="#modal-recommended-time">
                                                <div class="ribbon ribbon-top bg-green">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-actions btn-actions d-md-block d-sm-block d-lg-block">
                                <div class="row g-2">
                                    <div class="col">
                                        <div class="form-group">
                                            <select type="text" class="form-select" id="select-enis"
                                                value=""></select>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <a href="javascript:void(0)" class="btn btn-icon" aria-label="Button"
                                            id="btnEniReload" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Supprimer le filtre">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-refresh" width="24"
                                                height="24" viewbox="0 0 24 24" stroke-width="2"
                ...
                <div class="col-lg-7">
                    <div class="card h-100">
                        <div class="card-header">
                            <h3 class="card-title">Statistique du formation langue par niveau et temps de formation
                            </h3>
                            <div class="card-actions btn-actions d-md-block d-sm-block d-lg-block d-none">
                                <div class="row g-2">
                                    <div class="col">
                                        <div class="form-group">
                                            <select type="text" class="form-select" id="select-langues"
                                                placeholder ="Séléctionner votre module" value=""></select>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex">
                                <h3 class="card-title">Répartition de temps de session,temps d'engagement, temps
                                    calculé et le temps pédagogique recommandé par domaine :</h3>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
