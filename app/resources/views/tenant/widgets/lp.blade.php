            ...
            <div class="card-actions btn-actions d-md-block d-sm-block d-lg-block d-none">
                <div class="row g-2">
                    ...
                    @if( request()->routeIs('tenant.plateforme.home') || request()->routeIs('tenant.project.home') || request()->routeIs('tenant.group.home') )
                        <div class="col-auto">
                            <a href="javascript:void(0)" class="btn  text-black" aria-label="Button" id="btnLpsExport" data-bs-toggle="tooltip" data-bs-placement="top" title="Générer votre rapport">
