                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="#" class="btn btn-red d-none d-sm-inline-block" data-bs-toggle="modal"
                            data-bs-target="#modal-report-group">
                        ...
                        <a href="#" class="btn btn-red d-sm-none btn-icon" data-bs-toggle="modal"
                            data-bs-target="#modal-report-group" aria-label="Générer vos rapports">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-spreadsheet"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <div class="btn-list">
                        <div class="mb-3 text-black">
                            <div class="input-group mb-2">
                                ...
                                <select type="text" class="form-select" id="select-groups" value="">
...
@section('ideoreport_js')
    <script src="{{ global_asset('scripts/group/group.js') }}"></script>
@stop
