<div>
    <div class="card h-100 {{ $card_color }}">
        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="{{'#'.$modal_name }}">
            <div class="ribbon ribbon-top {{ $bg_color }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help-octagon-filled"
                    width="32" height="32" viewbox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none"
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-baseline">
                <div class="h2 mb-0 me-2">{{ $total_time }}</div>
            </div>
            <div class="d-flex align-items-baseline">
                <div class="h5 mb-0 me-2 text-black fw-bolder ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-math-avg" width="24"
    ...
    <div class="modal modal-blur fade" id="{{ $modal_name }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-status {{ $bg_color }}"></div>
                <div class="modal-body text-center py-4">
                    <!-- Download SVG icon from http://tabler-icons.io/i/circle-check -->
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-help-octagon icon mb-2 {{ $text_color }} icon-lg"
